...
export const saveProjectSetup = mutation({
  args: {
    ...
    hasBasement: v.optional(v.boolean()),
    hasYard: v.optional(v.boolean()),
    yardPavedArea: v.optional(v.number()),
    yardGardenArea: v.optional(v.number()),
    hasPool: v.optional(v.boolean()),
    poolType: v.optional(v.union(v.literal('built'), v.literal('prefab'))),
    housingUnits: v.optional(v.number()),
  ...
  handler: async (ctx, args) => {
    ...
    const projectPatch = {
      ...
      ...(args.hasBasement !== undefined ? { hasBasement: args.hasBasement } : {}),
      ...(args.hasYard !== undefined ? { hasYard: args.hasYard } : {}),
      ...(args.yardPavedArea !== undefined ? { yardPavedArea: args.yardPavedArea } : {}),
      ...(args.yardGardenArea !== undefined ? { yardGardenArea: args.yardGardenArea } : {}),
      ...(args.hasPool !== undefined ? { hasPool: args.hasPool } : {}),
      ...(args.poolType !== undefined ? { poolType: args.poolType } : {}),
      ...(args.housingUnits !== undefined ? { housingUnits: args.housingUnits } : {}),
