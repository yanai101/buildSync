...
export const NAV = [
  ...
  { id: "/stages",        label: "שלבי ביצוע", icon: "layers",    section: "ניהול",   roles: OWNER_MANAGER_INSPECTOR },
  { id: "/contractors",   label: "כרטסת קבלנים",     icon: "users",     section: "ניהול",   roles: OWNER_MANAGER_INSPECTOR },
  { id: "/orders",        label: "מעקב הזמנות",icon: "search",     section: "ניהול",   roles: OWNER_MANAGER_INSPECTOR },
  { id: "/boq",           label: "ניהול עלויות רכש", icon: "clipboard", section: "ניהול",   roles: OWNER_MANAGER_INSPECTOR },
  ...
  { id: "/permits",       label: "רישוי וביורוקרטיה",     icon: "folder", section: "ניהול", roles: OWNER_MANAGER_INSPECTOR },
