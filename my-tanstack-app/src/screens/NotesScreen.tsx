...
export const NotesScreen = () => {
  const { data: initialNotes, loading, error, refetch } = useDataSource<Note[]>('notes');
  ...
  const toggleResolved = (id: number) => setNotes(prev=>prev.map(n=>n.id===id?{...n,resolved:!n.resolved}:n));
